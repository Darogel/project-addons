...
{
    'name': 'Partner Data Import - CSV',
    'summary': "Import Partner Data from CSV with Different columns",
    'description': "Import Partner Data from CSV with Different columns",
    'version': '13.0.0.1.0',
    'category': 'Base',
